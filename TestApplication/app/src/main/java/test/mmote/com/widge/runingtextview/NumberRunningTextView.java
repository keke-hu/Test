package test.mmote.com.widge.runingtextview;
...
public class NumberRunningTextView extends TextView {
    ...
    private boolean useDecimalPoint;//是否使用小数点，让数字显得比较好看，默认使用
    ...
    public NumberRunningTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        useDecimalPoint = ta.getBoolean(R.styleable.NumberRunningTextView_useDecimalPoint, true);
            ...
            floatAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (useCommaFormat) {
                        ...
                        String formatStr;
                        if (useDecimalPoint) {
                            formatStr = StringUtils.addComma(str);//三位一个逗号格式的字符串
                        } else {
                            formatStr = StringUtils.addCommaNoDecimalPoint(str);
                        }
                        setText(formatStr);
                    } else {
                        setText(str);
